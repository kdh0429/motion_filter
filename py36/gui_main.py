...
parser.add_argument("--max_buffer", type=int, default=5000, help="pyqtgraph max buffer size")
parser.add_argument("--plot_hz", type=int, default=10, help="pyqtgraph update hz")
